...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService {
  ...
  // The hostnames in the preceding URLs are not actual DNS names. Instead, they
  // are the virtual hostnames that are used by the microservices when they
  // register themselves to the Eureka server, in other words, the values of the
  ...
  public ProductCompositeIntegration(
      ...
      // Once a WebClient is built, it is immutable. This means that it can be reused
