...
public class ProductServiceImpl implements ProductService {
  ...
  public Mono<Product> getProduct(int productId, int delay, int faultPercent) {
    ...
    return repository.findByProductId(productId)
        // applies the throwErrorIfBadLuck method to see whether an exception needs
        // to be thrown. Next, it applies a delay using the delayElement function in the
        // Mono class
  ...
  private ProductEntity throwErrorIfBadLuck(ProductEntity entity, int faultPercent) {
    ...
    // throws an exception if it is higher than, or equal
    // to, the specified fault percentage
