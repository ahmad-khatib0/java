...
#
# 2 Run the tests for RabbitMQ with two partitions per topic using the 
#   Docker Compose dockercompose-partitions.yml
# $ export COMPOSE_FILE=docker-compose-partitions.yml
# $ ./test-em-all.bash start stop
# $ unset COMPOSE_FILE
#
# 3 Finally, run the tests with Kafka and two partitions per topic using the: dockercompose-kafka.yml
