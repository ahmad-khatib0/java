...
// The @DataJpaTest annotation is designed to start an embedded database by
...
class PersistenceTests extends MySqlTestBase {
  ...
  void optimisticLockError() {
    ...
    // This should fail since the second entity now holds 
    // an old version number, i.e. an Optimistic Lock Error
